...
// Original github repository: https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/kakao-js-sdk
...
const defaultKakaoSdkOptions: VueKakaoSdkOptions = {
  apiKey: '',
...
const kakao = ref<typeof Kakao>({} as typeof Kakao)
...
function closureInitializeScript (scriptUrl: string, scriptId: string, apiKey: string) {
